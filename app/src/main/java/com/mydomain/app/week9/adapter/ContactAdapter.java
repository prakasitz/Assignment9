...
public class ContactAdapter extends RecyclerView.Adapter<ContactViewHolder>{
    ...
    public void onBindViewHolder(ContactViewHolder contactViewHolder, int i){
        ...
        contactViewHolder.tvId.setText("ID: " + String.valueOf(contact.getId()));
        contactViewHolder.tvName.setText(contact.getName());
        contactViewHolder.tvEmail.setText(String.valueOf(contact.getEmail()));
        contactViewHolder.tvPhone.setText(String.valueOf(contact.getPhone()));
    }
